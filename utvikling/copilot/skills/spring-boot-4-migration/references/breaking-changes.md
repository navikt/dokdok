...
See [camel-migration.md](camel-migration.md) for full Camel migration details, including:
- BOM and dependencies POM setup (Camel 4.20.0+)
- MDC logging module extraction (`camel-mdc`)
